...
exchange = conf['trading']['exchange']
...
stop_limit_percent_sell = float(conf['trading']['stop_limit_percent_sell'])
stop_limit_percent_buy = float(conf['trading']['stop_limit_percent_buy'])
